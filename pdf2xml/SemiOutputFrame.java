...
Table undo_table;
      ...
      try {
        ...
        this.add(main_panel);
  	    ...
  	    next();
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: constructor. " + e);
        }
    }
    ...
    public void cancel_exit_clicked() {
      try {
        ...
        this.dispose();
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: cancel_exit_clicked. " + e);
      }
    }
      ...
      try {
    	if (this.counter >0 && this.counter<=this.tables.size()) {
    	  ...
    	  next();
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: delete. " + e);
      }     
    ...
    public void merge() {
      ...
      if (this.counter >= 2) {
	      ...
	      next();
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: merge. " + e);
    }     
    ...
    public void edit(int index) {
      ...
      this.undo_table = (Table) current_table.clone();
       ...
       final EditTableCellFrame etc = new EditTableCellFrame(current_table, index);
       ...
       etc.setVisible(true);
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: edit. " + e);
    }
     ...
     public void edit_table_clicked() {      
      ...
      final EditTableContentFrame etc = new EditTableContentFrame(current_table);
      etc.setVisible(true);
      etc.addWindowListener(
           new WindowAdapter() {
             public void windowClosed( WindowEvent e ) {
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: edit_table_clicked. " + e);
    }
    ...
    public void change_table(Table t) {
     ...
     next();
           ...
           System.out.println("Exception in class: SemiOutputFrame and method: merge_cells. " + e);
    }
